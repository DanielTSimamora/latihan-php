...
class TodoModel
{
    ...
    {
        // Urut berdasar 'position' supaya hasil drag & drop persist
    ...
    {
        $q = 'SELECT id, activity, status, position, created_at, updated_at
              FROM todo WHERE id=$1 LIMIT 1';
        $res = pg_query_params($this->conn, $q, [$id]);
    ...
    public function createTodo($activity)
    {
        ...
        $query = 'INSERT INTO todo (activity, position, created_at) VALUES ($1, $2, NOW())';
